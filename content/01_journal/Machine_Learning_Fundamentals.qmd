...
```{r}
# STOCK PRICES
sp_500_prices_tbl <- read_rds("C:\\Users\\fvsha\\Documents\\GitHub\\ss23-bdml-VictorReaver1999\\Business Decisions with Machine Learning\\sp_500_prices_tbl.rds")
sp_500_prices_tbl
```
...
```{r}
# SECTOR INFORMATION
sp_500_index_tbl <- read_rds("C:\\Users\\fvsha\\Documents\\GitHub\\ss23-bdml-VictorReaver1999\\Business Decisions with Machine Learning\\sp_500_index_tbl.rds")
sp_500_index_tbl
```
